<template>
  <div class="this_page">
    ...
    <div ref="searchRef">
      <el-form inline :model="formData" class="custom_form" label-width="120px" style="padding: 0 20px"
        ...
        <el-row :gutter="30">
          ...
          <el-col :span="6" v-if="!formData.selectTimeType">
          </el-col>
          ...
          <el-col :span="6" v-if="formData.selectTimeType == '3'">
            <el-form-item label="统计时间" label-width="80px" class="form_item">
              <DateQuarter style="width: 100%" ref="seasonSelect" placeholder="请选择季度"
                           @chooseSeason="seasonChange"/>
            </el-form-item>
          </el-col>
          <el-col :span="6" v-if="formData.selectTimeType == '4'">
            <el-form-item label="统计时间" label-width="80px" class="form_item">
              <el-date-picker style="width: 100%" v-model="formData.time" type="year" placeholder="请选择年"
                              format="YYYY" valueFormat="YYYY"/>
            </el-form-item>
          </el-col>
          ...
          <!--            <el-select collapse-tags collapse-tags-tooltip v-model="formData.company" multiple filterable-->
          ...
          <el-col :span="6">
            <el-form-item label="服务区" label-width="80px" class="form_item">
              <el-select v-model="formData.serviceName" multiple filterable placeholder="请选择服务区" clearable
                         collapse-tags
        ...
        <el-row :gutter="30">
          ...
          <!--            <el-select collapse-tags collapse-tags-tooltip v-model="formData.roadRoute" multiple filterable-->
          ...
          <el-col :span="6">
            <el-form-item label="运营单位" label-width="80px" class="form_item">
              <el-select v-model="formData.operatorUnit" multiple filterable placeholder="请选择运营单位" clearable
                         collapse-tags
                         collapse-tags-tooltip>
    ...
    <el-table v-loading="loading"
              ...
              :data="tableData"
              style="width: 100%">
      <el-table-column type="index" label="序号" fixed="left" width="60" align="center"/>
      <el-table-column prop="serviceAreaName" label="服务区名称" fixed="left" min-width="120" align="center"/>
      <el-table-column prop="serviceAreaCode" label="服务区编号" fixed="left" width="120" align="center"/>
      <el-table-column prop="stationName" label="充电站名称" fixed="left" min-width="140" align="center"/>

      <el-table-column prop="stationId" label="充电站编号" fixed="left" width="120" align="center"/>
      <!--      <el-table-column prop="equipmentId" label="充电桩编号" align="center"/>-->
      <el-table-column prop="operationUnit" label="运营单位" min-width="120" align="center"/>
      ...
      <el-table-column prop="superChargeNum" label="超充数量" width="120" sortable align="center"/>
      <el-table-column prop="superChargePower" label="超充功率（KW）" width="160" align="center"/>
      <el-table-column prop="fastChargeNum" label="快充数量" width="160" sortable align="center"/>
      <el-table-column prop="fastChargePower" label="快充功率（KW）" width="160" align="center"/>
      ...
      <el-table-column prop="failureRate" label="故障率(%)" width="160" sortable align="center">
        <template #header>
          <div style="display: flex; align-items: center">
            <span style="display: flex; align-items: center">
              ...
              <el-popover placement="top-start" title="故障率(%)" effect="dark" width="auto" trigger="hover"
                          content="（求和（每一个枪的故障时长）/枪总数*24）">
                <template #reference>
      ...
      <el-table-column prop="onlineRate" label="在线率(%)" width="160" sortable align="center">
        <template #header>
          <div style="display: flex; align-items: center">
            <span style="display: flex; align-items: center">
              <span>
              ...
              <el-popover placement="top-start" title="在线率(%)" effect="dark" width="auto" trigger="hover"
                          content="（1-离网率）">
                <template #reference>
                  <el-icon color="#fa8c16" size="18">
                    <QuestionFilled/>
...
const exportList = ref([
  ...
  {
    value: 'superChargeNum',
    label: '超充数量',
    checked: true,
  },
  {
    value: 'superChargePower',
    label: '超充功率（KW）',
    checked: true,
  },
  {
...
const getData = async () => {
  ...
  const params = {
    ...
    roadSection: formData.roadSection ? flattenArray(formData.roadSection) : null
  };

  let res = await getChargeReportStationList(params);
  if (res.code == 200) {
...
function exportExcel(fileList) {
  ...
  exportData("/rmt/chargeReportStation/export", "充电站维度", params);
  exportShow.value = false;
}
