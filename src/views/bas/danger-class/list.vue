...
<template>
  <div class="this_page">
    <div>
      <el-radio-group v-model="switchStatistics" style="margin-bottom: 20px">
        <el-radio-button label="1" value="1">统计表</el-radio-button>
        <el-radio-button label="2" value="2">统计图</el-radio-button>
      </el-radio-group>
    </div>
    <div v-if="switchStatistics == 1">
      <!-- 筛选项 -->
      <div ref="searchRef">
        <el-form
          inline
      ...
      >
        ...
        >
          ...
          <template #default="scope">
            <el-link type="primary" @click="toDetail(scope.row,null,2)">{{
              scope.row.totalNum
            }}</el-link>
          </template>
        </el-table-column>
        ...
        >
          ...
          <template #default="scope">
            <el-link type="primary" @click="toDetail(scope.row,null,1)">{{
              scope.row.totalDangerNum
            }}</el-link>
          </template>
        </el-table-column>
        <el-table-column label="易燃易爆" width="140" align="center">
          <el-table-column
            prop="flammExpl"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '易燃易爆',1)"
                >{{ scope.row.flammExpl }}</el-link
              >
            </template>
          </el-table-column>
          <el-table-column
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '易燃易爆',1)"
                >{{ scope.row.flammExplRate }}</el-link
              >
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="腐蚀品" width="140" align="center">
          <el-table-column
            prop="corrosive"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row, '腐蚀品',1)">{{
                scope.row.corrosive
              }}</el-link>
            </template>
          </el-table-column>
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row, '腐蚀品',1)">{{
                scope.row.corrosiveRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="有毒品" width="140" align="center">
          <el-table-column
            prop="toxic"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row, '有毒品',1)">{{
                scope.row.toxic
              }}</el-link>
            </template>
          </el-table-column>
        ...
        <el-table-column label="压缩气体和液化气体" width="140" align="center">
          <el-table-column
            prop="compressedGas"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '压缩气体和液化气体',1)"
                >{{ scope.row.compressedGas }}</el-link
              >
            </template>
          </el-table-column>
          <el-table-column
            prop="compressedGasRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '压缩气体和液化气体',1)"
                >{{ scope.row.compressedGasRate }}</el-link
              >
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="易燃液体" width="140" align="center">
          <el-table-column
            prop="flammLiquid"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '易燃液体',1)"
                >{{ scope.row.flammLiquid }}</el-link
              >
            </template>
          </el-table-column>
          <el-table-column
            prop="flammLiquidRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '易燃液体',1)"
                >{{ scope.row.flammLiquidRate }}</el-link
              >
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="易燃固体" width="140" align="center">
          <el-table-column
            prop="flammSolid"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '易燃固体',1)"
                >{{ scope.row.flammSolid }}</el-link
              >
            </template>
          </el-table-column>
          <el-table-column
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '易燃固体',1)"
                >{{ scope.row.flammSolidRate }}</el-link
              >
            </template>
          </el-table-column>
        </el-table-column>
        ...
        >
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '自燃物品和遇湿易燃物品',1)"
                >{{ scope.row.waterReact }}</el-link
              >
            </template>
          </el-table-column>
          <el-table-column
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '自燃物品和遇湿易燃物品',1)"
                >{{ scope.row.waterReactRate }}</el-link
              >
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="放射性物品" width="140" align="center">
          <el-table-column
            prop="radioactive"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '放射性物品',1)"
                >{{ scope.row.radioactive }}</el-link
              >
            </template>
          </el-table-column>
          <el-table-column
            prop="radioactiveRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link
                type="primary"
                @click="toDetail(scope.row, '放射性物品',1)"
                >{{ scope.row.radioactiveRate }}</el-link
              >
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="空车" width="140" align="center">
          <el-table-column
            prop="empty"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row, '空车',1)">{{
                scope.row.empty
              }}</el-link>
            </template>
          </el-table-column>
        ...
        <el-table-column label="00:00-06:00" width="140" align="center">
          <el-table-column
            prop="zeroToSix"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.zeroToSixRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="06:00-08:00" width="140" align="center">
          <el-table-column
            prop="sixToEight"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.sixToEightRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="08:00-10:00" width="140" align="center">
          <el-table-column
            prop="eightToTen"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.eightToTenRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="10:00-12:00" width="140" align="center">
          <el-table-column
            prop="tenToTwelve"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.tenToTwelve
              }}</el-link>
            </template>
          </el-table-column>
          <el-table-column
            prop="tenToTwelveRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.tenToTwelveRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="12:00-14:00" width="140" align="center">
          <el-table-column
            prop="twelveToFourteen"
            sortable="custom"
            label="数量"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.twelveToFourteen
              }}</el-link>
            </template>
          </el-table-column>
          <el-table-column
            prop="twelveToFourteenRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.twelveToFourteenRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="14:00-16:00" width="140" align="center">
          <el-table-column
            prop="fourteenToSixteen"
            sortable="custom"
            label="数量"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.fourteenToSixteen
              }}</el-link>
            </template>
          </el-table-column>
          <el-table-column
            prop="fourteenToSixteenRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.fourteenToSixteenRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="16:00-18:00" width="140" align="center">
          <el-table-column
            prop="sixteenToEighteen"
            sortable="custom"
            label="数量"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.sixteenToEighteen
              }}</el-link>
            </template>
          </el-table-column>
          <el-table-column
            prop="sixteenToEighteenRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.sixteenToEighteenRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="18:00-20:00" width="140" align="center">
          <el-table-column
            prop="eighteenToTwenty"
            sortable="custom"
            label="数量"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.eighteenToTwenty
              }}</el-link>
            </template>
          </el-table-column>
          <el-table-column
            prop="eighteenToTwentyRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.eighteenToTwentyRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="20:00-22:00" width="140" align="center">
          <el-table-column
            prop="twentyToTwo"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.twentyToTwo
              }}</el-link>
            </template>
          </el-table-column>
          <el-table-column
            prop="twentyToTwoRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.twentyToTwoRate
              }}</el-link>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="22:00-24:00" width="140" align="center">
          <el-table-column
            prop="twentyToFour"
            sortable="custom"
            label="数量"
          ...
          >
            <template #default="scope">
              <el-link type="primary" @click="toDetail(scope.row)">{{
                scope.row.twentyToFour
              }}</el-link>
            </template>
          </el-table-column>
          <el-table-column
            prop="twentyToFourRate"
            sortable="custom"
            label="占比（%）"
            width="120"
            align="center"
    ...
    <dangerClassNewReport v-if="switchStatistics == 2" />
  </div>
</template>
...
import dangerClassNewReport from "../danger-class-new-report/list.vue";
...
} from "@/api/dangerClass/index.js";

const loading = ref(false);
const exportShow = ref(false);
const timestamp = ref(new Date().getTime());
const switchStatistics = ref(1);
...
const toDetail = (row, name,carType) => {
  let data = {
    ...
    highSpeed: row.highSpeed, //路线
    serviceAreaId: row.serviceAreaId, //服务区
    name: name ?? "",
    carType:carType
  };
...
const handleSortChange = ({ column, prop, order }) => {
  ...
  if (order) {
    ...
    let newColumn = prop; // 危化品分类单独不转驼峰
    orderColumn.value = {
      column: newColumn,
      order: order,
    };
...
onActivated(() => {
  // formData.time = moment().subtract(0, "day").format("YYYY-MM-DD");
  // formData.time =
  //   route.query && route.query.time
  //     ? route.query.time
  //     : moment().subtract(0, "day").format("YYYY-MM-DD");
  // formData.serviceAreaIds =
  //   route.query && route.query.serviceSelects ? route.query.serviceSelects : [];
  // formData.orgIds =
  //   route.query && route.query.companySelects ? route.query.companySelects : [];
  getDictionary();
  getData();
});
onMounted(() => {
