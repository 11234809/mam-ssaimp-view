...
<script setup>
	...
	const dangerCarEcharts = () => {
	  let chartData = [
                {value: 235, name: '客车', itemStyle: {color: '#1DA7C0'}},
                {value: 274, name: '货车', itemStyle: {color: '#E28E61'}},
                {value: 310, name: '新能源车', itemStyle: {color: '#CECE41'}}
      ]
	  nextTick(() => {
	    if (!dangerCarChart) {
	...
	const dangerCarNetEcharts = () => {
	  let chartData = [
                {value: 100, name: '男客', itemStyle: {color: '#1DA7C0'}},
                {value: 50, name: '女客', itemStyle: {color: '#E28E61'}},
                {value: 310, name: '其他', itemStyle: {color: '#CECE41'}}
      ]
	  nextTick(() => {
